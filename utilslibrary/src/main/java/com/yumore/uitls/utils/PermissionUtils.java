package com.yumore.uitls.utils;
...
public final class PermissionUtils {
    ...
    public static void requestCameraPermission(@NonNull Fragment fragment) {
        if (fragment.shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(fragment.getString(R.string.request_camera_permission), PermissionUtils.REQUEST_CAMERA_PERMISSION, true)
    ...
    public static void requestCameraPermission(@NonNull FragmentActivity activity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.CAMERA)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(activity.getString(R.string.request_camera_permission),
    ...
    public static void requestStoragePermission(@NonNull Fragment fragment) {
        if (fragment.shouldShowRequestPermissionRationale(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(fragment.getString(R.string.request_storage_permission), PermissionUtils.REQUEST_STORAGE_PERMISSION)
                    .show(fragment.getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public static void requestStoragePermission(@NonNull FragmentActivity activity) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(activity.getString(R.string.request_storage_permission), PermissionUtils.REQUEST_STORAGE_PERMISSION)
                    .show(activity.getSupportFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public static void requestRecordSoundPermission(@NonNull Fragment fragment) {
        if (fragment.shouldShowRequestPermissionRationale(Manifest.permission.RECORD_AUDIO)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(fragment.getString(R.string.request_sound_permission), PermissionUtils.REQUEST_SOUND_PERMISSION)
                    .show(fragment.getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public static void requestRecordSoundPermission(FragmentActivity activity) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.RECORD_AUDIO)) {
            com.yumore.uitls.fragment.PermissionConfirmDialogFragment.newInstance(activity.getString(R.string.request_sound_permission),
                    PermissionUtils.REQUEST_SOUND_PERMISSION)
                    .show(activity.getSupportFragmentManager(), FRAGMENT_DIALOG);
        } else {
            ActivityCompat.requestPermissions(activity,
