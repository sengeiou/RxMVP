...
import com.yumore.facedetect.utils.SensorEventUtil;
...
public final class FaceTracker {
    ...
    // 人脸检测参数
    private final com.yumore.facedetect.engine.FaceTrackParam mFaceTrackParam;

    // 检测线程
    private TrackerThread mTrackerThread;

    private FaceTracker() {
        mFaceTrackParam = com.yumore.facedetect.engine.FaceTrackParam.getInstance();
    }
    ...
    public static void requestFaceNetwork(Context context) {
        if (Facepp.getSDKAuthType(ConUtil.getFileContent(context, R.raw
            ...
            com.yumore.facedetect.engine.FaceTrackParam.getInstance().canFaceTrack = true;
            return;
        }
        ...
        licenseManager.takeLicenseFromNetwork(uuid, com.yumore.facedetect.utils.FaceppConstraints.API_KEY, com.yumore.facedetect.utils.FaceppConstraints.API_SECRET, apiName,
                ...
                new LicenseManager.TakeLicenseCallback() {
                    ...
                    public void onFailed(int i, byte[] bytes) {
                        ...
                        com.yumore.facedetect.engine.FaceTrackParam.getInstance().canFaceTrack = false;
                    }
                });
    }
     ...
     * @return
     */
    public com.yumore.facedetect.engine.FaceTrackerBuilder setFaceCallback(com.yumore.facedetect.listener.FaceTrackerCallback callback) {
        return new com.yumore.facedetect.engine.FaceTrackerBuilder(this, callback);
    }
    ...
    private static class TrackerThread extends Thread {
        ...
        private synchronized void internalPrepareFaceTracker(Context context, int orientation, int width, int height) {
            com.yumore.facedetect.engine.FaceTrackParam faceTrackParam = com.yumore.facedetect.engine.FaceTrackParam.getInstance();
