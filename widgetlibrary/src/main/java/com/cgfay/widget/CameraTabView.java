...
public class CameraTabView extends HorizontalScrollView {
    ...
    public CameraTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabIconTintMode = ViewUtils.parseTintMode(a.getInt(android.support.design.R.styleable.TabLayout_tabIconTintMode, -1), null);
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorCenter) { // 指示器居中显示
                Drawable selectedIndicator = DrawableCompat.wrap(mTabSelectedIndicator != null ? mTabSelectedIndicator : mDefaultSelectionIndicator);
