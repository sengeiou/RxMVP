...
import com.yumore.common.callback.OnLinkPreviewListener;
...
public class TextCrawler {
    ...
    private OnLinkPreviewListener callback;
    ...
    public void makePreview(OnLinkPreviewListener callback, String url) {
    ...
    private String getTagContent(String tag, String content) {
        ...
        List<String> matches = RegexUtils.regexMatchAll(content, pattern, 2);
        ...
        if (result.equals("")) {
            String matchFinal = RegexUtils.regexMatch(content, pattern, 2);
    ...
    private boolean isImage(String url) {
        return url.matches(RegexUtils.IMAGE_PATTERN);
    }
    ...
    private HashMap<String, String> getMetaTags(String content) {
        ...
        List<String> matches = RegexUtils.regexMatchAll(content,
                RegexUtils.METATAG_PATTERN, 1);
    ...
    private String separeMetaTagsContent(String content) {
        String result = RegexUtils.regexMatch(content, RegexUtils.METATAG_CONTENT_PATTERN,
                1);
        return htmlDecode(result);
    }
    ...
    public class GetCode extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if (callback != null) {
                callback.onPosition(sourceContent, isNull());
            }
                ...
                if (isImage(sourceContent.getFinalUrl())
                    ...
                    try {
                        ...
                        if (sourceContent.getTitle().equals("")) {
                            String matchTitle = RegexUtils.regexMatch(
                                    sourceContent.getHtmlCode(),
                                    RegexUtils.TITLE_PATTERN, 2);
