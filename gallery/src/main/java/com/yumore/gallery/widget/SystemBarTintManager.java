...
public class SystemBarTintManager {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            try {
                ...
                navBarOverride = (String) method.invoke(null, "qemu.hw.mainkeys");
            } catch (Throwable e) {
                navBarOverride = null;
            }
        }
    ...
    public SystemBarTintManager(AppCompatActivity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            try {
                statusBarAvailable = typedArray.getBoolean(0, false);
                navBarAvailable = typedArray.getBoolean(1, false);
            } finally {
                typedArray.recycle();
            }
        ...
        systemBarConfig = new SystemBarConfig(activity, statusBarAvailable, navBarAvailable);
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, systemBarConfig.getStatusBarHeight());
        params.gravity = Gravity.TOP;
        if (navBarAvailable && !systemBarConfig.isNavigationAtBottom()) {
            params.rightMargin = systemBarConfig.getNavigationBarWidth();
        }
    ...
    private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
        ...
        if (systemBarConfig.isNavigationAtBottom()) {
            params = new LayoutParams(LayoutParams.MATCH_PARENT, systemBarConfig.getNavigationBarHeight());
            params.gravity = Gravity.BOTTOM;
        } else {
            params = new LayoutParams(systemBarConfig.getNavigationBarWidth(), LayoutParams.MATCH_PARENT);
