...
import com.yumore.scan.adapter.AlbumScanAdapter;
...
public class MediaScanActivity extends AppCompatActivity implements AlbumScanner.AlbumScanCallbacks,
    ...
    private void initView() {
        mLayoutTitle = findViewById(R.id.layout_album_title);
        mAlbumTitle = findViewById(R.id.album_title);
        mAlbumArrow = findViewById(R.id.album_arrow);
        mLayoutContainer = findViewById(R.id.fragment_container);

        // TODO 待优化（使用ViewStub进行延迟加载）
        mLayoutEmptyPage = findViewById(R.id.layout_empty_page);

        // 相册列表
        mLayoutAlbumSelect = findViewById(R.id.layout_album_select);
        mAlbumScanAdapter = new AlbumScanAdapter(this, null, false);
        mListAlbums = findViewById(R.id.lv_albums);
