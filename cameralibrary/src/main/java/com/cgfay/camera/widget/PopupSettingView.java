...
public class PopupSettingView extends BasePopupWindow
    ...
    private void init() {
        ...
        mLayoutFlash = contentView.findViewById(R.id.layout_flash);
        mImageFlash = contentView.findViewById(R.id.iv_flash);
        mTextFlash = contentView.findViewById(R.id.tv_flash);

        mLayoutTouchTake = contentView.findViewById(R.id.layout_touch_take);
        mImageTouchTake = contentView.findViewById(R.id.iv_touch_take);
        mTextTouchTake = contentView.findViewById(R.id.tv_touch_take);

        mLayoutCameraSetting = contentView.findViewById(R.id.layout_camera_setting);

        mLayoutTimeLapse = contentView.findViewById(R.id.layout_time_lapse);
        mImageTimeLapse = contentView.findViewById(R.id.iv_time_lapse);
        mTextTimeLapse = contentView.findViewById(R.id.tv_time_lapse);

        mLuminousCompensation = contentView.findViewById(R.id.sw_luminous_compensation);
        mEdgeBlur = contentView.findViewById(R.id.sw_edge_blur);
