...
public class EffectType implements Parcelable {
    ...
    private final EffectMimeType mimeType;    // 特效类型，滤镜特效、转场特效以及时间特效
    private final String mThumb;  // 缩略图路径
    private final String mName;   // 特效名
    private final int id;         // 特效id，暂时没啥用。本来是预留做动态处理的id。
