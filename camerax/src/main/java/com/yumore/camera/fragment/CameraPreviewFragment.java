package com.yumore.camera.fragment;
...
import com.yumore.camera.presenter.CameraPreviewPresenter;
import com.yumore.camera.utils.PathConstraints;
import com.yumore.camera.widget.AspectFrameLayout;
import com.yumore.camera.widget.CainTextureView;
import com.yumore.camera.widget.PopupSettingView;
import com.yumore.camera.widget.RecordSpeedLevelBar;
import com.yumore.camera.widget.ShutterButton;
...
import com.yumore.uitls.utils.DisplayUtils;
...
import com.yumore.widget.CameraTabView;
...
//        mCameraSurfaceView.getHolder().addCallback(mSurfaceCallback);
        ...
        mPreviewTop = view.findViewById(R.id.layout_preview_top);
        view.findViewById(R.id.btn_close).setOnClickListener(this);
        view.findViewById(R.id.btn_select_music).setOnClickListener(this);

        mFpsView = view.findViewById(R.id.tv_fps);
        ...
        mPreviewRightTop = view.findViewById(R.id.layout_preview_right_top);
        mBtnSetting = view.findViewById(R.id.btn_setting);
        mBtnSetting.setOnClickListener(this);
        mBtnSwitch = view.findViewById(R.id.btn_switch);
        mBtnSwitch.setOnClickListener(this);
        mBtnSpeed = view.findViewById(R.id.btn_speed);
        mBtnSpeed.setOnClickListener(this);
        mBtnEffect = view.findViewById(R.id.btn_effects);
        ...
        mBtnViewPhoto = view.findViewById(R.id.btn_view_photo);
