...
import com.yumore.rxdemo.adapter.AdapterLeftMenu;
import com.yumore.rxdemo.adapter.AdapterRightDish;
import com.yumore.rxdemo.interfaces.ShopCartInterface;
import com.yumore.rxdemo.model.ModelDish;
import com.yumore.rxdemo.model.ModelDishMenu;
import com.yumore.rxdemo.model.ModelShopCart;
import com.yumore.rxdemo.view.RxDialogShopCart;
import com.yumore.rxdemo.view.RxFakeAddImageView;
import com.yumore.rxdemo.view.RxPointFTypeEvaluator;
...
public class ActivityELMe extends ActivityBase implements AdapterLeftMenu.onItemSelectedListener, ShopCartInterface, RxDialogShopCart.ShopCartDialogImp {
    ...
    RxTitle mRxTitle;
    @BindView(R2.id.shopping_cart_total_tv)
    ...
    @BindView(R2.id.right_menu_tv)
    TextView headerView;
    @BindView(R2.id.right_menu_item)
    LinearLayout headerLayout;//右侧菜单栏最上面的菜单
    @BindView(R2.id.shopping_cart)
    ImageView mShoppingCart;
    @BindView(R2.id.shopping_cart_layout)
    FrameLayout mShoppingCartLayout;
    @BindView(R2.id.shopping_cart_total_num)
