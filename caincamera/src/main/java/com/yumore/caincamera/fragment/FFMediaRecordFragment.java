...
public class FFMediaRecordFragment extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // 录制预览
        mGLRecordView = mContentView.findViewById(R.id.gl_record_view);
        ...
        // 进度条
        mProgressView = mContentView.findViewById(R.id.record_progress_view);

        // 录制按钮
        mRecordButton = mContentView.findViewById(R.id.record_button);
