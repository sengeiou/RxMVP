...
import com.yumore.caincamera.renderer.RecordRenderer;
...
public class SpeedRecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 录制预览
        mGLRecordView = findViewById(R.id.gl_record_view);
        ...
        // 进度条
        mProgressView = findViewById(R.id.record_progress_view);

        // 速度条
        mRecordSpeedBar = findViewById(R.id.record_speed_bar);
