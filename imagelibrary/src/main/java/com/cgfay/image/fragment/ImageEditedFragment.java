...
public class ImageEditedFragment extends Fragment implements View.OnClickListener {
    ...
    private void showToolbox() {
        ...
        if (mLayoutToolbox == null) {
            ...
            mBtnToolboxBack = mLayoutToolbox.findViewById(R.id.btn_toolbox_back);
            mBtnAdjust = mLayoutToolbox.findViewById(R.id.btn_adjust);
            mBtnEffect = mLayoutToolbox.findViewById(R.id.btn_effect);
            mBtnTexture = mLayoutToolbox.findViewById(R.id.btn_texture);
            mBtnBlur = mLayoutToolbox.findViewById(R.id.btn_blur);
            mBtnCurve = mLayoutToolbox.findViewById(R.id.btn_curve);
            mBtnHueSaturation = mLayoutToolbox.findViewById(R.id.btn_hue_saturation);
            mBtnToneSeparation = mLayoutToolbox.findViewById(R.id.btn_tone_separation);
            mBtnColorBalance = mLayoutToolbox.findViewById(R.id.btn_color_balance);
