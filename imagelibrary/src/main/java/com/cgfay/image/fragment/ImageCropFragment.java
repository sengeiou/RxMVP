...
public class ImageCropFragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void initView(View view) {
        ...
        mCropCoverView = view.findViewById(R.id.image_cop_view);
        mCropTypeView = view.findViewById(R.id.crop_type);
        mCropProgress = view.findViewById(R.id.crop_progress);
        mCropProgress.setOnSeekBarChangeListener(this);

        mBtnHorizontal = view.findViewById(R.id.btn_horizontal);
        mBtnRatio = view.findViewById(R.id.btn_ratio);
        mBtnRotate = view.findViewById(R.id.btn_rotate);
        mBtnFlip = view.findViewById(R.id.btn_flip);
        mBtnVPerspective = view.findViewById(R.id.btn_vertical_perspective);
        mBtnHPerspective = view.findViewById(R.id.btn_horizontal_perspective);
        mBtnStretch = view.findViewById(R.id.btn_stretch);
